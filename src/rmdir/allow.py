"""
Rmdir (remove directory) policy rule for safe directory operations.

This rule blocks absolute paths and upward directory traversals in rmdir commands.
"""
...
def rmdir_safe_operations_rule(input_data: ToolUseEvent):
    """Blocks rmdir operations with options, absolute paths or upward directory traversals."""
