...
def test_sqlite3_select_with_where(client, base_event):
    ...
    check_policy(
        client,
        base_event,
        "sqlite3 db.sqlite 'SELECT * FROM users WHERE id = 1'",
        "allow",
    )
...
def test_sqlite3_select_with_join(client, base_event):
    ...
    check_policy(
        client,
        base_event,
        "sqlite3 db.sqlite 'SELECT * FROM users JOIN orders ON users.id = orders.user_id'",
        "allow",
    )
...
def test_sqlite3_select_count(client, base_event):
    ...
    check_policy(
        client, base_event, "sqlite3 db.sqlite 'SELECT COUNT(*) FROM users'", "allow"
    )
...
def test_sqlite3_select_multiline(client, base_event):
    ...
    check_policy(
        client,
        base_event,
        "sqlite3 db.sqlite 'SELECT id, name FROM users LIMIT 10'",
        "allow",
    )
...
def test_sqlite3_explain_query(client, base_event):
    ...
    check_policy(
        client, base_event, "sqlite3 db.sqlite 'EXPLAIN SELECT * FROM users'", "allow"
    )
...
def test_sqlite3_update_denied(client, base_event):
    ...
    check_policy(
        client,
        base_event,
        "sqlite3 db.sqlite 'UPDATE users SET name = \"new\" WHERE id = 1'",
        "deny",
    )
...
def test_sqlite3_delete_denied(client, base_event):
    ...
    check_policy(
        client, base_event, "sqlite3 db.sqlite 'DELETE FROM users WHERE id = 1'", "deny"
    )
...
def test_sqlite3_create_denied(client, base_event):
    ...
    check_policy(
        client, base_event, "sqlite3 db.sqlite 'CREATE TABLE test (id INT)'", "deny"
    )
...
def test_sqlite3_alter_denied(client, base_event):
    ...
    check_policy(
        client,
        base_event,
        "sqlite3 db.sqlite 'ALTER TABLE users ADD COLUMN age INT'",
        "deny",
    )
...
def test_sqlite3_attach_denied(client, base_event):
    ...
    check_policy(
        client,
        base_event,
        "sqlite3 db.sqlite 'ATTACH DATABASE \"other.db\" AS other'",
        "deny",
    )
...
def test_sqlite3_detach_denied(client, base_event):
    ...
    check_policy(
        client, base_event, "sqlite3 db.sqlite 'DETACH DATABASE other'", "deny"
    )
