...
def test_npm_install_defers_to_user(client, base_event):
    check_policy(client, base_event, "npm install", None)
...
def test_yarn_install_defers_to_user(client, base_event):
    check_policy(client, base_event, "yarn install", None)
...
def test_pnpm_install_defers_to_user(client, base_event):
    check_policy(client, base_event, "pnpm install", None)
