...
test_uv_add_pass1_incomplete_asks_for_pypi_metadata if {
	...
	}] with input as {"parsed": {
		"executable": "uv", "subcommand": "add",
		"arguments": ["fastapi"], "flags": [], "options": {},
	}}
}
...
test_uv_add_pass1_incomplete_strips_extras_in_require if {
	decisions[{
		...
		"executable": "uv", "subcommand": "add",
		"arguments": ["uvicorn[standard]"], "flags": [], "options": {},
	}}
}
...
test_uv_add_pass1_incomplete_from_dev_option_value if {
	decisions[{
		...
		"executable": "uv", "subcommand": "add",
		"arguments": [], "flags": [], "options": {"--dev": "pytest-cov"},
	}}
}
...
test_uv_add_pass2_deny_young_package_uses_stripped_key if {
	decisions[{
		"action": "deny",
		"reason": concat("", [
			"Package 'uvicorn' is only 5 days old (first released 1.0.0). ",
...
test_uv_add_unsafe_flags_denied_without_pypi_lookup if {
	decisions[{
		...
		"executable": "uv", "subcommand": "add",
		"arguments": ["fastapi"], "flags": ["--unsafe-flag"], "options": {},
	}}
}
