...
decisions contains decision if {
	...
	decision := {
		"action": "deny",
		"reason": concat("", [
			"No Python package manager bundle is active. Before using any tool, please choose one: ",
			"enable 'python_pip' (for pip-based projects) or 'python_uv' (for uv-based projects).",
		]),
	}
}
